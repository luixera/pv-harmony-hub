...
// A célula vinha do export original com "text-secondary bg-primary-foreground",
// que neste tema é texto quase branco (96%) sobre fundo quase preto (10%): toda
// linha de tabela saía escura dentro de um card claro. Sem isso a célula herda o
// fundo do card e o hover/zebra da linha volta a aparecer.
