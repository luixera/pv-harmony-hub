...
| Zé (assistente no WhatsApp) | 🟡 Conecta, espelha, responde e escreve com confirmação (entregas 1-3); rotinas/aprendizado pendentes; só GD Manager | [modules/ze](docs/modules/ze/overview.md) |
